              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    We blend creativity and technology to build digital products
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed">
                  We offer end-to-end services to help businesses thrive in the
                  digital landscape.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
              ...
              <Card className="bg-background/60 backdrop-blur-lg">
                <CardHeader>
                  ...
                  <CardDescription>
                    Custom online stores with seamless shopping experiences and
                    payment integration.
                  </CardDescription>
                </CardHeader>
                <CardFooter>
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                  {[1, 2, 3].map((item) => (
                    ...
                    >
                      <div className="aspect-square overflow-hidden">
                        <Image
                          src={`/placeholder.svg?height=600&width=600&text=Web+${item}`}
                          width={600}
                          height={600}
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                  {[1, 2].map((item) => (
                    ...
                    >
                      <div className="aspect-square overflow-hidden">
                        <Image
                          src={`/placeholder.svg?height=600&width=600&text=Mobile+${item}`}
                          width={600}
                          height={600}
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                  {[1].map((item) => (
                    ...
                    >
                      <div className="aspect-square overflow-hidden">
                        <Image
                          src={`/placeholder.svg?height=600&width=600&text=Brand+${item}`}
                          width={600}
                          height={600}
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed">
                    Founded in 2015, Nexus has grown from a small team of
                    passionate designers and developers to a full-service
                    digital agency with offices in New York, London, and Tokyo.
                  </p>
                </div>
              ...
              {[
                {
                  ...
                  role: "CEO, TechStart",
                  quote:
                    "Working with Nexus transformed our digital presence. Their team understood our vision and delivered beyond our expectations.",
                },
                {
                  name: "Michael Chen",
                  role: "Marketing Director, GrowthBrand",
                  quote:
                    "The attention to detail and creative solutions provided by Nexus helped us increase our conversion rates by 40% in just three months.",
                },
                {
                  name: "Emma Rodriguez",
                  role: "Founder, EcoLife",
                  quote:
                    "Nexus didn't just build us a website, they created a digital ecosystem that perfectly represents our brand values and mission.",
                },
                {
                  name: "David Kim",
                  role: "CTO, InnovateTech",
                  quote:
                    "The development team at Nexus is exceptional. They delivered our complex web application on time and with impeccable code quality.",
                },
                {
                  name: "Jessica Taylor",
                  role: "Creative Director, ArtHouse",
                  quote:
                    "As a design-focused company, we have high standards. Nexus not only met them but exceeded them with their creative approach and technical expertise.",
                },
      ...
      <footer className="w-full border-t bg-background py-12 md:py-16 lg:py-20">
        <div className="container px-4 md:px-6">
          ...
          <div className="mt-12 border-t pt-8 text-center text-sm text-muted-foreground">
            <p>
              © {new Date().getFullYear()} Nexus Digital Agency. All rights
              reserved.
            </p>
          </div>
        </div>
